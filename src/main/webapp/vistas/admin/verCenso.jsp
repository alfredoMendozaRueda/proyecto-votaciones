<%--
    Selector de ambito para consultar el censo.
--%>
...
<%
    ...
    String tituloPagina = "Ver censo - Sistema de Votaciones";
%>
<%@ include file="/WEB-INF/incluidos/cabecera.jspf" %>
<div class="container">
    <h1>Ver censo de</h1>
    <form action="<%= request.getContextPath() %>/servletVerCenso" accept-charset="UTF-8">
        <div class="acciones">
