...
<%
    ...
    try {
        listaCenso = FabricaServicios.censoServicio().censoPorComunidad(nombreComunidad);
    ...
    String tituloPagina = "Censo por comunidad - Sistema de Votaciones";
%>
<%@ include file="/WEB-INF/incluidos/cabecera.jspf" %>
<div class="container-ancho">
    <h1>Censo en <%= nombreComunidad %></h1>
