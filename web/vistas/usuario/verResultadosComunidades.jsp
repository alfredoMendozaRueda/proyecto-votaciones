<%-- 
    Document   : verResultadosComunidades
    Created on : 11 nov 2025, 23:41:32
    Author     : ferre
--%>
...
<html>
    ...
    <body>
        ...
        String id_comunidad=bbdd.getId_com((String)session.getAttribute("nombre_comunidad"));
    
                for (int i = 0; i < nomPartidos.size(); i++) {
                    %><tr>
                        <th><%=nomPartidos.get(i)%></th>
                        <th><%=bbdd.cantidadVotoSegunComunidad(nomPartidos.get(i),id_comunidad)%></th>
