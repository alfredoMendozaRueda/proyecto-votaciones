  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/admin/partidos/admin-partidos').then((m) => m.AdminPartidos),
      },
      {
        ...
        data: { roles: ['admin', 'analista'] },
        loadComponent: () =>
          import('./features/admin/candidatos/admin-candidatos').then((m) => m.AdminCandidatos),
      },
      {
        path: 'admin/censo',
        canActivate: [roleGuard],
      ...
      },
      {
        ...
        data: { roles: ['admin'] },
        loadComponent: () =>
          import('./features/admin/elecciones/admin-elecciones').then((m) => m.AdminElecciones),
      },
      {
        path: 'analista/panel',
        canActivate: [roleGuard],
        data: { roles: ['analista'] },
        loadComponent: () =>
          import('./features/analista/panel/analista-panel').then((m) => m.AnalistaPanel),
      },
      {
        ...
        data: { roles: ['analista'] },
        loadComponent: () =>
          import('./features/analista/comprobar-partidos/comprobar-partidos').then(
            (m) => m.ComprobarPartidos,
          ),
      },
      {
        ...
        data: { roles: ['analista'] },
        loadComponent: () =>
          import('./features/analista/candidatos-localidad/candidatos-localidad').then(
            (m) => m.CandidatosLocalidad,
          ),
      },
      {
        ...
        data: { roles: ['analista'] },
        loadComponent: () =>
          import('./features/analista/porcentajes/porcentajes').then((m) => m.Porcentajes),
      },
      {
        ...
        data: { roles: ['analista'] },
        loadComponent: () =>
          import('./features/analista/cookie/cookie-ganador').then((m) => m.CookieGanador),
      },
      {
        path: 'usuario/panel',
        canActivate: [roleGuard],
        data: { roles: ['votante'] },
        loadComponent: () =>
          import('./features/votante/panel/votante-panel').then((m) => m.VotantePanel),
      },
      {
        path: 'votacion',
        canActivate: [roleGuard],
